...
class KnowledgeHandler:
    ...
    async def answer_navigation(self, question: str) -> str:
        ...
        system = (
            ...
            "CRITICAL INTENT DISAMBIGUATION — CROP BUYING vs OTHER BUYING:\n"
            "There are THREE different 'buying' flows in Krushi Ratn. You MUST pick the correct one:\n\n"
            "1. BUYING CROPS (pak/pako/agricultural produce) FROM FARMERS:\n"
            "   → Use screen: 'Company — Buy Crops from Farmers'\n"
            "   → Triggered by ANY of these phrasings:\n"
            "     • Generic: 'buy crops', 'buy crop', 'pak kharidu', 'pako kharidu',\n"
            "       'mane pak kharido', 'i want to buy crops', 'crop purchase',\n"
            "       'company buy crop', 'ખેડૂત પાસેથી ખરીદ', 'પાક ખરીદ',\n"
            "       'મારે પાક ખરીદવા છે'\n"
            "     • Buy intent + ANY SPECIFIC CROP NAME (this is the most common case):\n"
            "       'buy wheat', 'buy ghau', 'buy ઘઉં',\n"
            "       'buy ginger', 'buy adu', 'buy આદુ', 'buy અદુ',\n"
            "       'buy onion', 'buy dungli', 'buy ડુંગળી',\n"
            "       'buy tomato', 'buy tameta', 'buy ટામેટા',\n"
            "       'buy potato', 'buy bataka', 'buy બટાકા',\n"
            "       'buy kapas', 'buy cotton', 'buy કપાસ',\n"
            "       'buy bajra', 'buy બાજરો', 'buy magfali', 'buy મગફળી',\n"
            "       'buy chana', 'buy ચણા', 'buy mung', 'buy મગ',\n"
            "       'buy jowar', 'buy જુવાર', 'buy makai', 'buy મકાઈ',\n"
            "       'buy soybean', 'buy સોયાબીન', 'buy tal', 'buy તલ',\n"
            "       'buy rice', 'buy chaval', 'buy ડાંગર', 'buy ચોખા',\n"
            "       'buy sugarcane', 'buy શેરડી', 'buy garlic', 'buy લસણ',\n"
            "       'buy mango', 'buy keri', 'buy કેરી', 'buy banana', 'buy કેળું',\n"
            "       and ANY OTHER specific crop / vegetable / fruit / grain / pulse / spice name.\n"
            "     • Phrasings: 'what can i do to buy <crop>', 'how to buy <crop>',\n"
            "       'where can i buy <crop>', 'i want to buy <crop>',\n"
            "       'mane <crop> kharidvu chhe', '<crop> kharidvi chhe'.\n"
            "   → RULE: The VERY FIRST sentence of your answer MUST say the user needs\n"
            "     to be logged in as a Company role.\n"
            "   → NEVER mention K-Shop or Buy/Sell marketplace for this intent.\n"
            "   → IMPORTANT: If the buy target is a CROP (any plant produce — grain,\n"
            "     vegetable, fruit, pulse, spice, oilseed), the answer is ALWAYS this\n"
            "     screen. K-Shop is ONLY for tools/seeds-as-input/fertilizer/pesticide,\n"
            "     never for raw produce. Buy/Sell is ONLY for animals/used goods,\n"
            "     never for raw produce.\n\n"
            "2. BUYING TOOLS / SEEDS / SUPPLIES:\n"
            "   → Use screen: 'K-Shop — Buy Product'\n"
            "   → Triggered by: 'buy from k-shop', 'buy kshop products', 'kshop product',\n"
            "     'buy fertilizer', 'buy pesticide', 'buy farm equipment', 'buy seed',\n"
            "     'buy seed for sowing', 'buy tools', 'buy supplies', 'buy sprayer',\n"
            "     'buy pump', 'buy thresher', 'buy weeder', 'buy seeder' (when explicitly\n"
            "     about NEW equipment with no 'used' signal),\n"
            "     'buy equipment from store', etc.\n"
            "   → This is for agricultural INPUTS and supplies — NEVER for raw crops/produce.\n\n"
            "3. BUYING ANIMALS / TRACTORS / USED ITEMS:\n"
            "   → Use screen: 'Buy/Sell — Buy a Product (Buyer)'\n"
            "   → Triggered by: 'buy cow', 'buy buffalo', 'buy goat', 'buy bakri',\n"
            "     'buy ગાય', 'buy ભેંસ', 'buy tractor' (used context), 'buy animal',\n"
            "     'buy used <anything>', 'buy second-hand <anything>',\n"
            "     'buy juno/juna/juni <anything>', 'juna vastu kharidu',\n"
            "     'buy from buy/sell', 'buy from buysell', 'buy from marketplace'.\n"
            "   → This is for ANIMALS and USED goods — NEVER for raw crops, NEVER for\n"
            "     new tools.\n\n"
            "SUMMARY TABLE:\n"
            "  Crops from farmer → Company role → screen 'Company — Buy Crops from Farmers'\n"
            "  Tools/seeds/supplies → K-Shop → screen 'K-Shop — Buy Product'\n"
            "  Animals/tractors/used → Buy/Sell → screen 'Buy/Sell — Buy a Product'\n\n"
