...
class KnowledgeHandler:
    ...
    async def answer_navigation(self, question: str) -> str:
        ...
        system = (
            ...
            "   → Triggered by: 'buy crops', 'buy crop', 'pak kharidu', 'pako kharidu',\n"
            "     'mane pak kharido', 'i want to buy crops', 'crop purchase', 'company buy crop',\n"
            "     'ખેડૂત પાસેથી ખરીદ', 'પાક ખરીદ', 'મારે પાક ખરીદવા છે', or any intent\n"
            "     to purchase agricultural crops from a farmer.\n"
            ...
            "   → Triggered by: 'buy from k-shop', 'kshop product', 'buy fertilizer',\n"
            "     'buy seed', 'buy equipment from store', etc.\n"
            "   → This is for agricultural inputs and supplies — NOT crops.\n\n"
            "3. BUYING ANIMALS / TRACTORS / USED ITEMS:\n"
            "   → Use screen: 'Buy/Sell — Buy a Product (Buyer)'\n"
            "   → Triggered by: 'buy cow', 'buy buffalo', 'buy tractor', 'buy animal',\n"
            "     'buy used item', 'secondhand', 'juna vastu kharidu', etc.\n"
            "   → This is for used goods — NOT crops, NOT tools.\n\n"
            "SUMMARY TABLE:\n"
